...
## Project Structure
    ...
    ├── testapiautoteammem_111656  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammem_111656`
...
2. Clone this repo and `cd testapiautoteammem_111656`
